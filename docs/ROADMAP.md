...
1. **Fork consolidation** — squash the stacked fork branches into one clean
   `weaver-fork` lineage; make the widget capacity profile a build option so
   stock fork tests pass; prepare the upstream PRs (TLS fix / #114, widget
