    ...
    <stack class="size-full rounded-[51px] overflow-hidden">
      <column class="size-full bg-[#1a1a1a] rounded-[51px] border border-[#000000] shadow-[0_1px_2px_0_#ffffff1a] shadow-inner p-[14px]">
        ...
        <row class="w-full mt-[4px] gap-[6px]">
          ...
          >
            <icon d="M 7 7 L 9.333 7 L 9.333 21 L 7 21 Z M 11.083 14 L 21 21 L 21 7 Z" class="w-[28px] h-[28px] text-[#d0d0d0]" />
          </button>
          <button
          ...
          >
            {playing
              ? <icon d="M 7 5.833 L 11.667 5.833 L 11.667 22.166 L 7 22.166 Z M 16.333 5.833 L 21 5.833 L 21 22.166 L 16.333 22.166 Z" class="w-[28px] h-[28px] text-[#d0d0d0]" />
              : <icon d="M 9.333 5.833 L 9.333 22.167 L 22.167 14 Z" class="w-[28px] h-[28px] text-[#d0d0d0]" />}
          </button>
          <button
            onPress={noop}
          ...
          >
            <icon d="M 7 21 L 16.917 14 L 7 7 Z M 18.667 7 L 21 7 L 21 21 L 18.667 21 Z" class="w-[28px] h-[28px] text-[#d0d0d0]" />
          </button>
        </row>
      </column>
